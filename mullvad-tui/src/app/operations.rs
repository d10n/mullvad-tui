...
pub enum Operation {
    ...
    SelectRelayCity,
    SelectEntryRelay,
    SelectEntryRelayCountry,
    SelectEntryRelayCity,
    ToggleMultihop,
...
impl fmt::Display for Operation {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let label = match self {
            ...
            Operation::SelectEntryRelay => "Select entry relay",
            Operation::SelectEntryRelayCountry => "Select entry relay country",
            Operation::SelectEntryRelayCity => "Select entry relay city",
